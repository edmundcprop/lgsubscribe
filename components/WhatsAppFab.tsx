...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-card-hover transition hover:scale-105"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
